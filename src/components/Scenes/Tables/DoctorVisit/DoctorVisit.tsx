    ...
    <div className="">
      <div className="overflow-x-auto rounded-lg shadow-md">
        <Table className="min-w-full whitespace-nowrap">
          ...
          <TableBody>
            {DoctorVisittableData.map((row, index) => (
              <TableRow
                key={index}
              ...
              >
                ...
                <TableCell className="px-3 py-2 text-gray-900  text-sm">{row.status}</TableCell>
    ...
    <div className="space-y-6 ">
      ...
      <div className="mb-4 ">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-4 lg:gap-8 mt-4">
          <div className="w-full   lg:max-w-3xl">
            <SelectDropDown
              value={FollowupdropdownValues.department}
              onChange={(value) => handleFollowupSelectChange("department", value)}
      ...
      <div className="flex lg:flex-row  flex-col items-center gap-4 lg:gap-8">
        <div className="w-full   lg:max-w-3xl">
          ...
          <SelectDropDown
            value={dropdownValues.method}
            onChange={(value) => handleFollowupSelectChange("method", value)}
            options={["Cash", "Online/UPI"]}
            placeholder="Select Method"
            inputClassName="outline-none rounded-lg bg-white h-[48px] shadow-md px-4"
            containerClassName="w-full"
        ...
        <div className="w-full  lg:max-w-3xl">
          ...
          <SelectDropDown
            value={dropdownValues.status}
            onChange={(value) => handleFollowupSelectChange("status", value)}
            options={["Pending", "Paid"]}
            placeholder="Select Status"
            inputClassName="outline-none rounded-lg bg-white h-[48px] shadow-md px-4"
            containerClassName="w-full"
